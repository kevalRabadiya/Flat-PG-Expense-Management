...
- **CORS** (`isAllowedCorsOrigin`): allows **`localhost`** / **`127.0.0.1`** (any port), **`https://*.onrender.com`**, **`https://*.vercel.app`**, and any full origin in **`CORS_ORIGINS`** (comma-separated). Other origins are rejected.
